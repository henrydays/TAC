...
novacor:   
        ...
        pop ax ;        ; Vai buscar 'a pilha o n�mero aleat�rio
        and al,01010000b    ; posi��o do ecran com cor de fundo aleat�rio e caracter a preto		
...
CICLO_CURSOR:       goto_xy POSxa,POSya ; Vai para a posi��o anterior do cursor
